...
float uNoiseFreq = 3.0f;   // density of cloud
float uFlowSpeed = 0.4f;   // rotation speed
float uWarpAmt = 1.2f;   // distortion
...
void Animate()
{
	// cap to ~60fps to reduce power draw and coil whine
...
Display()
{
	...
	Pattern.SetUniformVariable("uTime", ElapsedSeconds());
	Pattern.SetUniformVariable("uFlowSpeed", uFlowSpeed);
